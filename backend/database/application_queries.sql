...
select l.name, l.number_of_seats, l.number_of_lockers
    , l.image_url, l.address, l.description_dutch, l.description_english, l.capacity
...
-- $insert_location
insert into public.locations (name, number_of_seats, number_of_lockers, image_url, address, authority_id, description_dutch, description_english, capacity)
values (?, ?, ?, ?, ?, ?, ?, ?, ?);

-- $update_location
update public.locations
set name = ?, number_of_seats = ?, number_of_lockers = ?, image_url = ?, address = ?, authority_id = ?, description_dutch = ?, description_english = ?, capacity = ?
where name = ?;
...
select y.mail, y.augentpreferredsn, y.augentpreferredgivenname, y.password, y.institution
	 ...
	 , l.name, l.number_of_seats, l.number_of_lockers, l.image_url, l.address, l.description_dutch, l.description_english, l.capacity
     , a.authority_id, a.authority_name, a.description
from y
...
group by y.mail, y.augentpreferredsn, y.augentpreferredgivenname, y.password, y.institution
     ...
     , l.description_dutch, l.description_english, l.capacity
     , a.authority_id, a.authority_name, a.description
order by l.name;
...
select l.location_name, l.number
	, s.name, s.number_of_seats, s.number_of_lockers, s.image_url, s.address, s.description_dutch, s.description_english, s.capacity
    , a.authority_id, a.authority_name, a.description
...
with recursive x as (
    ...
    select l.location_name, l.number
         ...
         , s.description_dutch, s.description_english, s.capacity
         , a.authority_id, a.authority_name, a.description
    ...
    from public.lockers l
        ...
        join public.authority a
            on a.authority_id = s.authority_id
        left join lr
            on lr.location_name = l.location_name
...
select r.location_name, r.number
     ...
     , r.description_dutch, r.description_english, r.capacity
...
select l.name, l.number_of_seats, l.number_of_lockers, l.image_url, l.address, l.description_dutch, l.description_english, l.capacity
       , a.authority_id, a.authority_name, a.description
