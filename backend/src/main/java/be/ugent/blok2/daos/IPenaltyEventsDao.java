...
public interface IPenaltyEventsDao extends IDao {
     ...
     */
    void addPenaltyEvent(PenaltyEvent event);
     ...
     */
    void addDescription(int code, Language language, String description);
     ...
     */
    void updatePenaltyEvent(int code, PenaltyEvent event);
     ...
     */
    void deleteDescription(int code, Language language);
