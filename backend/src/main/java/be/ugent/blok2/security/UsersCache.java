...
public class UsersCache {
    ...
    private HashMap<String, Pair<String, User>> users; //Key: generated code, Value: Pair of session id and user
    private IGenerator<String> sessionMappingGenerator = new SessionMappingGenerator();
