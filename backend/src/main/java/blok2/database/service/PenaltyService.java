...
import blok2.database.repository.PenaltyRepository;
...
public class PenaltyService implements IPenaltyDao {
     ...
     */
    private final LocalDateTime RESET_DATE = LocalDateTime.of(2024, Month.DECEMBER, 1, 0, 0);
    ...
    private int getActualPointsOfPenalty(Penalty p) {
        return p.getCreatedAt().isAfter(RESET_DATE) ? p.getPoints() : 0;
    }
