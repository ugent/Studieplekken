...
export function equalLocations(
  location1: Location,
  location2: Location
): boolean {
...
export function equalCalendarPeriods(
  ...
  return (
    equalLocations(period1.location, period2.location) &&
...
export function equalCalendarPeriodsForLockers(
  period1: CalendarPeriodForLockers,
  period2: CalendarPeriodForLockers
): boolean {
  if (period1 === null && period2 == null) {
    return true;
  }
