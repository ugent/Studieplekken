...
export class LocationsManagementComponent implements OnInit {
    ...
    private currentTimeslotsToDelete: Timeslot[];
    ...
    prepareToDeleteLocation(
        ...
        this.calendarPeriodService
            ...
            .subscribe((next) => {
                ...
                this.currentTimeslotsToDelete.sort(
                    (timeslota: Timeslot, timeslotb: Timeslot) => timeslota.getStartMoment().diff(timeslotb.getStartMoment())
                );
